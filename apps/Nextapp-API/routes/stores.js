  ...
  async (req, res) => {
    try {
      ...
      const result = await executeQuery(
        ...
        WHERE Branch_Code = ?`,
        [
          Branch_Name !== undefined ? Branch_Name : existingStore.Branch_Name,
          companyName !== undefined ? companyName : existingStore.Company_Name,
          Branch_Address !== undefined ? Branch_Address : existingStore.Branch_Address,
          Branch_Phone !== undefined ? Branch_Phone : existingStore.Branch_Phone,
          Branch_Email !== undefined ? Branch_Email : existingStore.Branch_Email,
          Branch_Manager !== undefined ? Branch_Manager : existingStore.Branch_Manager,
          Branch_URL !== undefined ? Branch_URL : existingStore.Branch_URL,
          Branch_Manager_Mobile !== undefined ? Branch_Manager_Mobile : existingStore.Branch_Manager_Mobile,
          store_image !== undefined ? store_image : existingStore.store_image,
          company_id !== undefined ? company_id : existingStore.company_id,
          branchCode
        ]
      );
